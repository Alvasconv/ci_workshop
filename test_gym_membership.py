...
class TestAvailabilityValidation:
    ...
    def test_validate_valid_features(self):
        ...
        is_valid, invalid = validate_features_availability(["personal_training", "group_classes"])
        assert is_valid is True
        assert len(invalid) == 0
    
    def test_validate_invalid_features(self):
        """Test validation with invalid features"""
        is_valid, invalid = validate_features_availability(["personal_training", "invalid_feature"])
        assert is_valid is False
...
class TestCostCalculation:
    ...
    def test_calculate_features_cost_multiple(self):
        ...
        cost, invalid = calculate_additional_features_cost(["personal_training", "group_classes"])
        assert cost == 70.00
        assert len(invalid) == 0
    
    def test_calculate_features_cost_invalid(self):
        """Test calculating cost with invalid features"""
        cost, invalid = calculate_additional_features_cost(["personal_training", "invalid"])
        assert cost == -1
    ...
    def test_calculate_total_cost_with_features(self):
        ...
        total, details = calculate_total_membership_cost("premium", ["personal_training", "nutrition_coaching"])
...
class TestEdgeCases:
    ...
    def test_duplicate_features(self):
        ...
        cost, invalid = calculate_additional_features_cost(["personal_training", "personal_training"])
